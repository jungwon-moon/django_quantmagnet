...
class Strategy_PER_ROE_SMALL:
    ...
    def calculate(self):
        ...
        with open("../react_quantmagnet/src/store/json/strategy_per_roe_small.json", "w") as f:
...
def run():
    strategy = Strategy_PER_ROE_SMALL()
    strategy.calculate()
